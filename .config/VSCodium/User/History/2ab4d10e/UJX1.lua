...
-- workspaces nxt nxt monitor (TV) 
hl.workspace_rule({ workspace = "15", monitor = "DP-2", persistent = true})
hl.workspace_rule({ workspace = "16", monitor = "DP-2",persistent = true})
hl.workspace_rule({ workspace = "17", monitor = "DP-2",persistent = true})
hl.workspace_rule({ workspace = "18", monitor = "DP-2",persistent = true})
hl.workspace_rule({ workspace = "19", monitor = "DP-2",persistent = true})
hl.workspace_rule({ workspace = "20", monitor = "DP-2",persistent = true})
hl.workspace_rule({ workspace = "21", monitor = "DP-2",persistent = true})
